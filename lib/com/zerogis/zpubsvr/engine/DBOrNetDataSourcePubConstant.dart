 ...
 * 修改备注：
 */
abstract class DBOrNetDataSourcePubConstant
{
  /*
   * 根据ID取图形信息
   *
   ...
   * @return
   */
  Future<dynamic> getGraph(int major, int minor, String id);
   ...
   * @return
   */
  Future<dynamic> getGraphs(int major, int minor, String ids);
   ...
   */
  Future<dynamic> queryByPage(int major, int minor,
   ...
   * @param pagesize    每页数据条数
   */
  Future<dynamic> queryByPageDefaultSize(int major, int minor,
   ...
   * @param id        实体ID:举例：id = 1
   */
  Future<dynamic> getTopGraph(int major, int minor, String id);
   ...
   * 
   */
  Future<dynamic> queryByWin(int major, int minor, String coor);
   ...
   * 
   */
  Future<dynamic> getAtt(int major,
      int minor,
      int id,);
   ...
   * 
   */
  Future<dynamic> queryUnion(int major,
      int minor,
      String tables,
      String exp,
      String cols,
   ...
   *
   */
  Future<dynamic> querySql(int major,
      int minor,
      String keyno,
      String exp,
      String cols,
...
/*
   ...
   *
   */
  Future<dynamic> addWithId(int major,
      int minor,
      Map map,);
   ...
   * 
   */
  Future<dynamic> delete(int major,
      int minor,
      Object id,);
   ...
   *
   */
  Future<dynamic> deletes(int major,
      int minor,
      String ids,);
   ...
   * 
   */
  Future<dynamic> updateCoor(int major,
      int minor,
      String id,
      String coor,);
   ...
   *
   */
  Future<dynamic> updateZTCoor(int major,
      int minor,
      String ztid,);
   ...
   * 
   */
  Future<dynamic> updateMap(int major,
      int minor,
      String id,
      String layer,
      String map,);
   ...
   * 
   */
  Future<dynamic> updateAngle(int major,
      int minor,
      String id,
      String ang,);
   ...
   * 
   */
  Future<dynamic> updateAtt(int major, int minor, String id, String cols);
   ...
   * 
   */
  Future<dynamic> updateAtts(int major,
      int minor,
      String ids,
      String separator,
      Map map,);
   ...
   * 
   */
  Future<dynamic> unlock(int major,
      int minor,
      String id,
      String lockid,);
   ...
   *
   */
  Future<dynamic> query(String exp,
      String types,
      String vals,
      {
        String cols,
   ...
   *
   */
  Future<dynamic> inserts(int major, int minor, String id, String _rcdnum,
      {String separator});
   ...
   *
   */
  Future<dynamic> getTableNum(int major, int minor, int id);
   ...
   * @param minor  0
   */
  Future<dynamic> getattgraph(int major, int minor, int id);
   ...
   * @param minor  0
   */
  Future<dynamic> getattgraphs(int major, int minor, String ids);
   ...
   * @param xy     坐标串
   */
  Future<dynamic> getGraphsByRange(int major, int minor, int gtype, int gr,
      int r, String xy);
   ...
   *  不支持排序
   */
  Future<dynamic> queryGra(int major,
      int minor,
      String exp,
      String types,
      String vals, {
   ...
   */
  Future<dynamic> addGra(int major, int minor, String coor);
   ...
   * @param coor:			坐标信息	(x1,y1,x2,y2,…)
   */
  Future<dynamic> addGraWithId(int major, int minor, String coor, int id);
   ...
   * @param cols:			如果只想更新部分列，可以用这个参数指明需要更新的列名(,分隔)
   */
  Future<dynamic> updateAttGra(int major, int minor, String cols, String coor);
   ...
   * @param id 
   */
  Future<dynamic> delpnt(int major, int minor, int id);
   ...
   */
  Future<dynamic> movpnt(int major, int minor, int id, String coor);
   ...
   */
  Future<dynamic> updTopLin(int major, int minor, String line, int oldid,
      int newid, int delpnt);
   ...
   * @param invalid:			无效点列表
   */
  Future<dynamic> getpnttop(int major, int minor, int id);
   ...
   * @param invalid:			无效点列表
   */
  Future<dynamic> explosion(int major, int minor, int dest, String invalid);
}
